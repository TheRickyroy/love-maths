...
function runGame (gameType) {
    ...
    // Create two random numbers 1- 25
...
/**
 * Check the user answer against the first element in
...
/**
 * Get the operands and operator directly from the dom,
 * and returnes the correct answer.
 */
